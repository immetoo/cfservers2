...
// CONFIG IS BELOW DOCS !!

/* A convenient name that will appear in the tree viewer and throughout
   phpLDAPadmin to identify this LDAP server to users. */
//$ldapservers->SetValue($i,'server','name','ldapserver');
...
// $ldapservers->SetValue($i,'server','host','ldaps://ldapserver');
...
// $ldapservers->SetValue($i,'server','base',array('dc=example,dc=nl'));
...
$ldapservers->SetValue($i,'server','name','ldap1.lan.mbuyu.nl');
$ldapservers->SetValue($i,'server','host','ldaps://ldap1.lan.mbuyu.nl');
$ldapservers->SetValue($i,'server','port','636');
$ldapservers->SetValue($i,'server','base',array('dc=m4n,dc=nl'));
$ldapservers->SetValue($i,'server','auth_type','session');
$ldapservers->SetValue($i,'login','dn','cn=admin,dc=m4n,dc=nl');

$i++;
$ldapservers->SetValue($i,'server','name','ldap2.lan.mbuyu.nl');
$ldapservers->SetValue($i,'server','host','ldaps://ldap2.lan.mbuyu.nl');
$ldapservers->SetValue($i,'server','port','636');
$ldapservers->SetValue($i,'server','base',array('dc=m4n,dc=nl'));
$ldapservers->SetValue($i,'server','auth_type','session');
$ldapservers->SetValue($i,'login','dn','cn=admin,dc=m4n,dc=nl');
...
$i++;
$ldapservers->SetValue($i,'server','name','ldap4.lan.mbuyu.nl');
$ldapservers->SetValue($i,'server','host','ldaps://ldap4.lan.mbuyu.nl');
$ldapservers->SetValue($i,'server','port','636');
$ldapservers->SetValue($i,'server','base',array('dc=m4n,dc=nl'));
$ldapservers->SetValue($i,'server','auth_type','session');
$ldapservers->SetValue($i,'login','dn','cn=admin,dc=m4n,dc=nl');
...
$i++;
$ldapservers->SetValue($i,'server','name','ldap3.lan.mbuyu.nl');
$ldapservers->SetValue($i,'server','host','ldaps://ldap3.lan.mbuyu.nl');
$ldapservers->SetValue($i,'server','port','636');
$ldapservers->SetValue($i,'server','base',array('dc=m4n,dc=nl'));
$ldapservers->SetValue($i,'server','auth_type','session');
$ldapservers->SetValue($i,'login','dn','cn=admin,dc=m4n,dc=nl');
