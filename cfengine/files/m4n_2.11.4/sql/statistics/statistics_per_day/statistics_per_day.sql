...
CREATE TABLE statistics_per_day_rows_to_insert AS SELECT
    ...
    MAX(affiliate_settings.account_manager_user_id)                                                AS affiliate_account_manager_user_id,
...
FROM
    ...
    /* SUBQUERY views_clicks_leads_count */ (
		...
		LEFT OUTER JOIN 
	affiliate_settings ON (affiliate_settings.affiliate_id = views_clicks_leads_count.affiliate_id)
    	LEFT OUTER JOIN 
