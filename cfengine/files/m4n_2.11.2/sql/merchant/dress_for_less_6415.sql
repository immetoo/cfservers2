...
Update February 18 2011, Jan, Extended deal until 01-04-2011. 
Update March 24 2011, Jan, Added advertisement 688883 to the deal 
*/
...
WHERE
	...
	lead.lead_program_id IN (SELECT id FROM lead_program WHERE merchant_id = 6415 AND lead_program_id != 4492) AND
	lead.created >= '2011-01-06' AND
	lead.created < '2011-04-01' AND
 	click.advertisement_id IN (672205, 288717, 288715, 243480, 243476, 243473, 688883);
